    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: ConstrainedBox(
          constraints:
              BoxConstraints(maxWidth: screenWidth > 600 ? 1000 : screenWidth),
                              ...
                              child: Row(
                                ...
                                children: [
                                  if (trackInfo.imageUrl != null &&
                                      ...
                                      Uri.tryParse(trackInfo.imageUrl!)
                                              ?.hasAbsolutePath ==
                                          true)
                                    ClipRRect(
...
class HeroLayoutCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: <Widget>[
        if (imgUrl != null && Uri.tryParse(imgUrl!)?.hasAbsolutePath == true)
          ClipRect(
            child: OverflowBox(
              maxWidth: width * 7 / 8,
              minWidth: width * 7 / 8,
          ...
          Container(
            ...
            height: width * 7 / 8,
            color: Colors.grey,
            child: const Icon(Symbols.music_note, size: 100),
          ),
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
